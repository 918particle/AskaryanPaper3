...
\title{Complex Analysis of Askaryan Radiation: Fully analytic reconstruction of UHECR}
...
\textit{A paragraph has been added to section two "The Askaryan Radio Array" in order to reflect this comment and a data release by the ARA collaboration.}
...
\textit{The smaller graphic is to display the entire wave form for the sake of transparency to any skeptical critics of the model. A final paragraph to section 4 before Fig 3. has been added to create a small break between sections 4 and 5}
...
\textit{Agreed, this is now appended to the aforementioned paragraph to clarify the meaning of the inserts and vertical-axis.}
